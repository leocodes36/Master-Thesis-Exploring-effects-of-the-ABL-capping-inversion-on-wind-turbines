...
if __name__ == "__main__":
    ...
    print("Generating the turbulence box with dimesnions","Nx:",Nx,"Ny:",Ny,"Nz:",Nz,"dx:",dx,"dy:",dy,"dz:",dz,"High-Freq-Comp:",High_freq_comp,"Base-name:",Base_name,"Seed(s):",seed_func_arg)
