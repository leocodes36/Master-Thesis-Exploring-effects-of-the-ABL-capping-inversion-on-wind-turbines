...
if __name__ == "__main__":
    ...
    constraints = CoherentWaveConstraint2(da, nominal_U, zhub, params["Nxyz"], params["dxyz"], A, N)

    # Use .constrain() method of the mtf object
    print(f'Constraining u to represent a laterally coherent wave of N:{N}s-^1 A:{A}m/s')
