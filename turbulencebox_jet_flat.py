...
from common import *
from constraint import constraint_gen_flat
...
# Jet is 6 [m/s] faster and double the turbulence
constraints = constraint_gen_flat(da, positions, U, 6, params["Nxyz"], params["dxyz"], 5)
...
# --- Figure 11 ---
# Plot the difference in the reference yr plane before and after constraining
plt.figure()
(da1.sel(uvw='u',y=yr)-da.sel(uvw='u',y=yr)).plot(x='x')
#plt.axis('scaled')
plt.grid()
